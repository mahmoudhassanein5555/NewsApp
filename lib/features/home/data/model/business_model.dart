...
class BusinessDto {
  ...
  BusinessDto({this.status, this.totalResults, this.articles});
  ...
  BusinessEntites toEntity() => BusinessEntites(
...
class ArticleDto {
  ...
  Articles toEntity() => Articles(
    ...
    urlToImage:
        urlToImage ??
        "https://seotoolspark.com/uploads/Dummy%20Image%20Placeholders%20Benefit.jpg",
    content: content ?? "",
